/****************************************************************************
** $Id: qtextcodec.cpp 8 2005-11-16 19:36:46Z dmik $
**
...
class QOS2LocalCodec: public QTextCodec
{
public:
    QOS2LocalCodec();
    ~QOS2LocalCodec();
...
QString QOS2LocalCodec::toUnicode(const char* chars, int len) const
{
    return qt_os2MB2QString( chars, len );
}

QCString QOS2LocalCodec::fromUnicode(const QString& uc, int& lenInOut ) const
{
    QCString r = qt_os2QString2MB( uc, lenInOut );
    lenInOut = r.length();
    return r;
}


const char* QOS2LocalCodec::name() const
{
    return "System";
}

int QOS2LocalCodec::mibEnum() const
{
    return 0;
}


int QOS2LocalCodec::heuristicContentMatch(const char* chars, int len) const
{
    // ### Not a bad default implementation?
    QString t = toUnicode(chars,len);
    int l = t.length();
