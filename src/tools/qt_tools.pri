...
tools {
	...
	os2:SOURCES += $$TOOLS_CPP/qdir_pm.cpp \
	 	  $$TOOLS_CPP/qfile_pm.cpp \
		  $$TOOLS_CPP/qfileinfo_pm.cpp \
		  $$TOOLS_CPP/qlibrary_pm.cpp \
		  $$TOOLS_CPP/qsettings_pm.cpp \
		  $$TOOLS_CPP/qmutex_pm.cpp \
		  $$TOOLS_CPP/qwaitcondition_pm.cpp \
		  $$TOOLS_CPP/qthreadstorage_pm.cpp \
		  $$TOOLS_CPP/qcriticalsection_p.cpp \
		  $$TOOLS_CPP/qsysxcpt_pm.cpp
	...
	irix-cc {
		QMAKE_PRE_LINK		= $(CXX) -c $(CXXFLAGS) -O1 $(INCPATH) -o $(OBJECTS_DIR)/qlocale.o tools/qlocale.cpp
	}
	irix-cc-64 {
		QMAKE_PRE_LINK		= $(CXX) -c $(CXXFLAGS) -O1 $(INCPATH) -o $(OBJECTS_DIR)/qlocale.o tools/qlocale.cpp
	}
