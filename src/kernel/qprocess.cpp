/****************************************************************************
** $Id: qprocess.cpp 43 2005-12-19 12:39:14Z dmik $
**
...
/*!
    ...
    \section1 Notes for OS/2 and Windows users

    Some OS/2 or Windows commands, for example, \c dir, are not provided by
    ...
    interpreter itself (\c cmd.exe on OS/2 and on some Windows systems), and ask
...
/*!
    \fn QProcess::PID QProcess::processIdentifier()
    ...
    Under OS/2 the return value is the PID of the process, or (~1) if no
    process belongs to this object.
