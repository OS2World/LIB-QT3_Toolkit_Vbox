/****************************************************************************
** $Id: qscrollbar.cpp 174 2007-11-06 22:27:57Z dmik $
**
			       ...
			       QPainter *p ) const
{
    ...
    // For the Warp4 style we need to always check also the "add line" and "sub line"
    // buttons (they could be activated/deactivated!), so we include them here
