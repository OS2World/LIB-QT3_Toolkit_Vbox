/****************************************************************************
** $Id: qsizegrip.cpp 8 2005-11-16 19:36:46Z dmik $
**
...
void QSizeGrip::mouseMoveEvent( QMouseEvent * e )
{
    ...
    while( PeekMessage( &msg, winId(), WM_MOUSEMOVE, WM_MOUSEMOVE, PM_REMOVE ) )
      ;
#elif defined (Q_WS_PM)
//@@TODO (dmik): is the code below really necessary?
    QMSG qmsg;
    while( WinPeekMsg( 0, &qmsg, winId(), WM_MOUSEMOVE, WM_MOUSEMOVE, PM_REMOVE ) )
      ;
#endif
    QApplication::syncX();
