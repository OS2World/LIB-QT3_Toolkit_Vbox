/****************************************************************************
** $Id: qstring.h 169 2007-03-31 16:22:28Z dmik $
**
...
extern Q_EXPORT const LocaleObject qt_os2DefLocaleObj();
extern Q_EXPORT const UconvObject qt_os2DefUconvObj();
extern Q_EXPORT QCString qt_os2QString2MB( const QString& s, int len=-1 );
extern Q_EXPORT QString qt_os2MB2QString( const char* mb, int len=-1 );
extern Q_EXPORT const char *qt_os2UconvFirstByteTable();
#endif
