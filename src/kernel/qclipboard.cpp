/****************************************************************************
** $Id: qclipboard.cpp 8 2005-11-16 19:36:46Z dmik $
**
...
/*!
    ...
    non-Qt applications (for example, the standard Clipboard Viewer shipped
    with OS/2) register themselves as clipboard viewers -- this is the
    limitation of the Presentation Manager, not Qt. Reconnecting this signal
    to a slot will restore its functionality (until another non-Qt application
    will again register itself as the clipboard viewer).
*/
