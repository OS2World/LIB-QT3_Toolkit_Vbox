/****************************************************************************
** $Id: menu.cpp 8 2005-11-16 19:36:46Z dmik $
**
    ...
    : QWidget( parent, name )
{
    ...
    QFont of( options->font().family(), options->font().pointSize() );
    int normID = options->insertItem( new MyMenuItem( "&Normal Font", of ) );
    options->connectItem( normID, this, SLOT(normal()) );
