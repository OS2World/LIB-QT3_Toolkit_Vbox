...
kernel {
	...
	os2:SOURCES += \
		  $$KERNEL_CPP/qapplication_pm.cpp \
		  $$KERNEL_CPP/qclipboard_pm.cpp \
		  $$KERNEL_CPP/qcolor_pm.cpp \
		  $$KERNEL_CPP/qcursor_pm.cpp \
		  $$KERNEL_CPP/qdesktopwidget_pm.cpp \
		  $$KERNEL_CPP/qdnd_pm.cpp \
		  $$KERNEL_CPP/qeventloop_pm.cpp \
		  $$KERNEL_CPP/qfont_pm.cpp \
		  $$KERNEL_CPP/qmime_pm.cpp \
		  $$KERNEL_CPP/qpixmap_pm.cpp \
		  $$KERNEL_CPP/qprocess_pm.cpp \
		  $$KERNEL_CPP/qpaintdevice_pm.cpp \
		  $$KERNEL_CPP/qpainter_pm.cpp \
		  $$KERNEL_CPP/qregion_pm.cpp \
		  $$KERNEL_CPP/qsound_pm.cpp \
		  $$KERNEL_CPP/qthread_pm.cpp \
		  $$KERNEL_CPP/qwidget_pm.cpp \
		  $$KERNEL_CPP/qfontengine_pm.cpp
...
#        when uncommented, make sure the static build of Qt library works well
#        (mkspecs\os2-g++\qmake.conf also needs to be altered)
#os2 {
#	pm_ft2lib {
#        INCLUDEPATH += $$pm_ft2lib.include
#		LIBS += $$pm_ft2lib.lib\ft2lib.lib
#	}
#	else:DEFINES += QT_PM_NO_FT2LIB
#}

## @todo (r=dmik): headers and sources below are substracted until implemented
os2 {
	HEADERS -= \
		$$KERNEL_P/qinputcontext_p.h \
		$$KERNEL_H/qprinter.h
