...
#ifdef Q_WS_PM
// defined in qeventloop_pm.cpp
extern bool qt_suppress_morph_warning;
#endif

int main( int argc, char * argv[] )
{
#ifdef Q_WS_PM
    qt_suppress_morph_warning = true;
#endif
    bool impl = FALSE;
    bool subcl = FALSE;
	...
	out << "**      by: The User Interface Compiler ($Id: main.cpp 8 2005-11-16 19:36:46Z dmik $)" << endl;
	out << "**" << endl;
