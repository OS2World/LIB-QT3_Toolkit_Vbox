...
**
** Created: Sun Nov 2 20:35:36 2014
    ...
    : QDialog( parent, name, modal, fl )
{
    ...
    TabWidget1->insertTab( Widget2, QString("") );
    ...
    TabWidget1->insertTab( Widget3, QString("") );
    ...
    TabWidget1->insertTab( Widget4, QString("") );
    ...
    TabWidget1->insertTab( Widget5, QString("") );
