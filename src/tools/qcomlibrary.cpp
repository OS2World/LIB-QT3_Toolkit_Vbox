/****************************************************************************
** $Id: qcomlibrary.cpp 99 2006-07-21 19:24:43Z dmik $
**
...
#  elif defined(Q_OS_OS2)
	typedef const char * _System (*UCMQueryVerificationDataProc)();
#  else
...
#elif defined(Q_OS_OS2)
    typedef QUnknownInterface* _System (*UCMInstanceProc)();
#else
