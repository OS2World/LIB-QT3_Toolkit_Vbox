/****************************************************************************
** $Id: qfontdatabase.h 8 2005-11-16 19:36:46Z dmik $
**
...
#ifdef Q_WS_PM
    // a dummy method for compatibility with platform independent
    // parts of QFontDatabase
    static void load( const QString &/*family*/ = QString::null,  int = -1 ) { }
#else    
