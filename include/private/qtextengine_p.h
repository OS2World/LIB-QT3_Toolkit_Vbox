/****************************************************************************
** $Id: qtextengine_p.h 169 2007-03-31 16:22:28Z dmik $
**
** ???
**
...
/// @todo (r=dmik) the definitions below is almost unchecked (no true unicode
//  support yet)

// Use wide char to contain DBCS char in one glyph
typedef unsigned short glyph_t;
...
/// @todo (r=dmik) it's a dummy version...
struct QScriptAnalysis {
    unsigned short script         :10;
    unsigned short bidiLevel         :5;
    unsigned short override          :1;
