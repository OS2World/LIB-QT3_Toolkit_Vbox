...
styles {
	...
	contains( styles, all ) {
		styles += mac cde motifplus sgi platinum compact interlace windows warp4 motif
	}
	...
	contains( styles, warp4 ) {
		HEADERS +=$$STYLES_H/qwarp4style.h
		SOURCES +=$$STYLES_CPP/qwarp4style.cpp
	}
	else:DEFINES += QT_NO_STYLE_WARP4
