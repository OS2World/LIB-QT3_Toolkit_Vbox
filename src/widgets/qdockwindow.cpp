/****************************************************************************
** $Id: qdockwindow.cpp 105 2006-07-27 17:22:05Z dmik $
**
...
{
#if defined (Q_WS_PM)
    // This widget has the WNoAutoErase flag, so we must erase the background
    // even if we don't paint anything else. Win32 version feels ok without this,
    // because it doesn't actually fully obey WResizeNoErase and WRepaintNoErase:
    // WM_ERASEBKGND always erases the background before WM_PAINT and after
    // every resize.
    erase();
#endif    
