/****************************************************************************
** $Id: qfile.cpp 8 2005-11-16 19:36:46Z dmik $
**
...
/*!
    ...
    and OS/2 systems you may want to use encodeName() (and decodeName()) to
...
/*!
    ...
    with Qt, you can use Unicode file names. On Unix and OS/2, these file
    names are converted to an 8-bit encoding. If you want to do your own
    file I/O on Unix or OS/2, you should convert the file name using this
