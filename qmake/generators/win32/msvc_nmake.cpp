/****************************************************************************
** $Id: msvc_nmake.cpp 8 2005-11-16 19:36:46Z dmik $
**
...
&NmakeMakefileGenerator::findDependencies(const QString &file)
{
    ...
    // [dmik] this method can be called from MakefileGenerator::init() before
    // precompH is set in NmakeMakefileGenerator::init(), so we check it
    // to avoid appending of NULL string to the list of dependencies
    if (!precompH.isNull()) {
