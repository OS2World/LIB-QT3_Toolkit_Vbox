/**********************************************************************
** $Id: qcombobox.cpp 174 2007-11-06 22:27:57Z dmik $
**
...
void QComboBox::mousePressEvent( QMouseEvent *e )
{
    ...
    if ( gs == QStyle::PMStyle )
        dropDown = count() && arrowRect.contains( e->pos() );
    else
        dropDown = count() && ( !editable() || arrowRect.contains( e->pos() ) );
