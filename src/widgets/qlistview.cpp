/****************************************************************************
** $Id: qlistview.cpp 174 2007-11-06 22:27:57Z dmik $
**
...
void QListViewItem::setup()
{
	...
	for ( uint i = 0; i < lv->d->column.size(); ++i ) {
	    if ( pixmap( i ) )
            {
                if ( lv->style().styleHint( QStyle::SH_GUIStyle ) == QStyle::PMStyle )
		    ph = QMAX( ph, pixmap( i )->height() + 4 );
                else
