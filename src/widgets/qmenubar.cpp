/****************************************************************************
** $Id: qmenubar.cpp 174 2007-11-06 22:27:57Z dmik $
**
...
void QMenuBar::openActPopup()
{
    ...
    // Warp4style: popup menus are displaced by 4
    const int xoffset = ( style().styleHint( QStyle::SH_GUIStyle ) == QStyle::PMStyle ) ? -4 : 0;
    QPoint pos = r.bottomLeft() + QPoint( xoffset, yoffset );
    if( reverse ) {
	pos = r.bottomRight() + QPoint( -xoffset, yoffset );
