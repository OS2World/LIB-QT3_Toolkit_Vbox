/****************************************************************************
** $Id: qwidget.h 102 2006-07-24 21:11:03Z dmik $
**
...
#endif    
    enum ClipMode { ClipDefault, Unclipped, ClipAll }; 
    HPS getTargetPS( ClipMode m = ClipDefault );    
...
#endif
#if defined(Q_WS_PM)
    WId      fId;                               // frame window handle
    HSWITCH  swEntry;                           // window list entry handle
    HPOINTER pmIcon;				// internal OS/2 icon
    uint     in_sendWindowState : 1;		// used by QWidget::setWindowState()
    uint     reserved : 7;                      // reserved for future binary compatibility
#endif
